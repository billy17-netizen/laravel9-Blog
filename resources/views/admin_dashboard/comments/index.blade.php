            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><a href="{{route('admin.comments.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Comments</a></div>
                    </div>
                        ...
                        <table class="table mb-0">
                            ...
                            @foreach($comments as $comment)
                                <tr>
                                    ...
                                    <td>{{\Str::limit($comment->the_comment,80)}}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{route('posts.show',$comment->post->slug)}}#comment_{{$comment->id}}" target="_blank">VIew Comment</a>
                                    </td>
