                        ...
                        <table class="table mb-0">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td><img width="50" src="{{$user->image ? asset('storage/' . $user->image->path) : asset('storage/usernotImage/placeholder_user.png')}}" alt=""></td>
                                    <td>{{$user->name}}</td>
                                    <td>{{$user->email}}</td>
                                    <td>{{$user->role->name}}</td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{route('admin.users.show',$user)}}" target="_blank">Related Posts</a>
                                    </td>
